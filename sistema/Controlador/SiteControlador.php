...
class SiteControlador extends Controlador
{
    ...
    public function buscar(): void
    {
        ...
        if (isset($busca) && strlen($busca) > 4) {
            ...
            if ($posts) {
                ...
                echo "<li class='list-group-item fw-bold'>Nenhum resultado encontrado.</li>";
            }
        } else {
            echo "<li class='list-group-item fw-bold'>Sua busca precisa ter mais de 4 caracteres.</li>";
        }
    }
    ...
    {
        echo $this->template->renderizar('termos.html', [
     ...
     * @return void
     */
    public function transparencia(): void
    {
        echo $this->template->renderizar('transparencia.html', [
