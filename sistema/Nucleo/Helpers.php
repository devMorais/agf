 ...
 *
 * @author Fernando Aguiar <ceo@unset.com.br>
...
class Helpers
{
    ...
    {
        $servidoresLocais = SERVIDORES_LOCAIS;
        $servidor = $_SERVER['SERVER_NAME'] ?? '';
        if (in_array($servidor, $servidoresLocais)) {
            return true;
        }
