...
/**
 * MODELO DE CONFIGURAÇÃO (template versionado).
 *
 * NÃO coloque segredos reais aqui. Este arquivo serve apenas de referência.
 *
 * Para o ambiente real:
 *   1. Copie este arquivo para "configuracao.php" no servidor:
 *        cp sistema/configuracao.example.php sistema/configuracao.php
 *   2. Edite "configuracao.php" diretamente no servidor com os valores reais.
 *   3. "configuracao.php" está no .gitignore — ele NUNCA é enviado ao GitHub.
 */
...
define('EMAIL_USUARIO', 'SEU_EMAIL');
define('EMAIL_SENHA', 'SENHA_DO_EMAIL');
